...
public class BattleShipGame {
    ...
    private ArrayList<String> sortedOnes = new ArrayList<String>();
    ...
    protected String makeAPos(int x, int y) {
    ...
    protected int[] makeAPos(String position) {
    ...
    protected String[] sortPositions(int shipSize) {
    ...
    private boolean compareSorted(String[] sorted) {
        int i = 0;
    ...
    protected void initializeGame(int numOfShips, int shipSize) {
            ...
            while(anyShipAlive()) {
                ...
                if (playerGuess != null) {
                    ...
                    for (Ship ship : this.shipList) {
                        ...
                        if (result > 0) {
                            ...
                            if (result == 1) {
                                ...
                                gameGraph.setBoardPos(this.makeAPos(playerGuess), result);
                            } else if (result == 2) {
                                System.out.print("already hit on ship " + shipNum);
                            }
                            else if (result == 3) {
                                System.out.println("hit, ship " + shipNum + " sunk");
                                gameGraph.setBoardPos(this.makeAPos(playerGuess), 1);
                            }
                        }
                        shipNum++;
                    }
                    if (!hitNow) {
                        ...
                        gameGraph.setBoardPos(this.makeAPos(playerGuess), 3);
                    }
                }
                this.score++;
            }
